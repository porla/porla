...
using porla::Rpc::Methods::Fs::FsSpace;
using porla::Rpc::Methods::Fs::FsSpaceReq;
using porla::Rpc::Methods::Fs::FsSpaceRes;
using porla::Rpc::Methods::Fs::FsSpaceQuota;
...
void FsSpace::Execute(const FsSpaceReq& req, ResponseWriterHandle cb)
{
    std::error_code ec;
