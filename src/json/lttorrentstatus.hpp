...
{
    static void from_json(const nlohmann::json& j, libtorrent::typed_bitfield<libtorrent::piece_index_t>& pieces)
    {
    }

    static void to_json(nlohmann::json& j, const libtorrent::typed_bitfield<libtorrent::piece_index_t>& pieces)
    {
    }

    static void from_json(const nlohmann::json& j, lt::torrent_status& ts)
    {
    }
